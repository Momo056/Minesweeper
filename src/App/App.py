...
class App:
    ...
    def start_game(self, game_parameters: Game_Parameters|None=None):
        ...
        grid = Grid(game_parameters.grid_size, game_parameters.grid_size, game_parameters.mine_percent)
        game = Game(grid)
    ...
    def show_menu(self):
        ...
        start_button = Button(self.menu_frame, text="Start Game", command=self.start_game)
        start_button.pack(pady=10)

        modify_button = Button(self.menu_frame, text="Modify Parameters", command=self.modify_parameters)
